...
const DefaultRouter2 = require('./DefaultRouter2');
const DefaultRouter3 = require('./DefaultRouter3');

router.use('/empresa', checkLogin, checkRolAdmin, require('./EmpresaRouter'));
router.use('/empleado', checkLogin, require('./EmpleadoRouter'));
router.use('/centro-costo', checkLogin, checkRolAdmin, require('./CentroCostoRouter'));
router.use('/credencial', require('./CredencialesRouter'));
router.use('/documentos-faltantes', checkLogin, require('./DocumentosFaltantesRouter'));
router.use('/jefe-directo', checkLogin, checkRolAdmin, require('./JefeDirectoRouter'));
router.use('/upload-file', checkLogin, require('./UploadFileRouter'));
router.use('/documentos', checkLogin, require('./DocumentosRouter'));
